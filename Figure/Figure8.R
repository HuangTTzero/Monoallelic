...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/new_analysis/high_RME_OR_CV.pdf",high_RME_OR_up_exp_p, device = "pdf", width = 15, height = 6, units = "cm", dpi = 300)
...
# Figure 8c
gene_disease<-read.xlsx("/data/R02/huangtt39/F1_OSN/analysis/figure/Figure5/ds_gene/mmc6.xlsx")[,c(15:17,19)]
...
Human_Mouse<-read.table(file="/data/R02/huangtt39/F1_OSN/analysis/figure/Figure5/ds_gene/Human_Mouse.txt",sep="\t",header=TRUE)[,c(4,10)]
Human_Mouse_subset<-Human_Mouse%>%subset(Gene.name%in%gene)%>%arrange(Gene.name)

Dsgene<-read.xlsx("/data/R02/huangtt39/F1_OSN/analysis/figure/Figure5/ds_gene/mmc7.xlsx")[,c(1:3)]
...
write.xlsx(Dsgene_RME,file="/data/R02/huangtt39/F1_OSN/new_analysis/Dsgene_RME.xlsx")
...
Dsgene_dot<-ggplot(data=Dsgene_RME_longer,aes(y=Mouse.gene.name,x=score_name,size=score,fill=score_name,color=score_name))+
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        ...
        legend.title = element_blank(),
        text=element_text(size=8))
ggsave(filename = "/data/R02/huangtt39/F1_OSN/new_analysis/Dsgene_dot.pdf",Dsgene_dot, device = "pdf", width = 8, height =8, units = "cm", dpi = 300)
