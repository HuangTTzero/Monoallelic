...
save(dscore_data,file="/data/R02/huangtt39/ATAC-RNAseq/analysis/merge/dscore_data.RData")
...
merge_count2plot<-data.frame(type=rep(c("Expression","Promoter","Combination"),2),allele_type=c("allele","allele","allele","total","total","total"),count=c(Orirna,Oripeak,Oriboth,allelerna,allelepeak,alleleboth))
#          type allele_type count
# 1  Expression      allele 26277
# 2    Promoter      allele 31069
# 3 Combination      allele 26172
# 4  Expression       total 22232
# 5    Promoter       total 28139
# 6 Combination       total 21599
...
ggsave(filename = "/data/R02/huangtt39/ATAC-RNAseq/analysis/figure/gene_count.pdf", gene_count_p, device = "pdf", width = 12, height = 7, units = "cm", dpi = 300)
