...
# 创建PDF文件
pdf("~/F1_OSN/analysis/figure/FigureS7/TAD_plots.pdf", 
...
output_pdf <- "~/F1_OSN/analysis/figure/FigureS7/all_genes_RNA_expression_log2.pdf"
...
plot_gene_hic_comparison_separate <- function(gene_row) {
  ...
  # 1. 创建PDF文件，每个基因一个文件
  pdf_file <- paste0("~/F1_OSN/analysis/figure/Figure/", 
...
save(link_peaks,file="~/F1_OSN/analysis/merge/RData/link_peaks.RData")
...
save(link_peak_anno_all,file="~/F1_OSN/analysis/merge/RData/link_peak_anno_all.RData")
link_peak_to_xlsx<-merge(link_peak_anno_all,link_peaks_df_subset,by=c("gene","peak"))
write.xlsx(link_peak_to_xlsx,file="~/F1_OSN/analysis/figure/FigureS7/link_peak_anno.xlsx")
...
RME<-read.xlsx("~/F1_OSN/analysis/figure/Figure2/Figure2h.xlsx")
...
ggsave(filename = "~/F1_OSN/analysis/figure/FigureS7/link_peak_enhancer_count.pdf",link_peak_enhancer_count_p, device = "pdf", width = 8, height = 7, units = "cm", dpi = 300)
...
write.csv(final_results, "~/F1_OSN/analysis/figure/FigureS7/linked_peaks_counts.csv", row.names = FALSE)
final_results<-read.table("~/F1_OSN/analysis/figure/FigureS7/linked_peaks_counts.csv")
...
ggsave(
  "~/F1_OSN/new_analysis/peak_dscore_scatterplot.pdf",
  p,
  width = 9,
  height = 4,
  dpi = 300
...
for(i in other_promoter2caculate$gene){
  file <- str_c("~/F1_OSN/analysis/figure/Figure2/RME/link/same/", i, ".pdf")
...
seqlength_file<-read.table(file="~/F1_OSN/mapping/reference/mm10-mask/fasta/genome.fa.fai")
seqlength<-seqlength_file$V2
names(seqlength)<-seqlength_file$V1
chip_dir<-"~/data/OSN/chip/"
...
setbigwig<-function(gene_name){
  ...
  bwlist<-list("~/data/OSN/chip/H3K9me3/GSM2454912_mOSN_H3K9me3_Mnase-ChIP_rep1.bigWig","~/data/OSN/chip/H3K9me3/GSM2454913_mOSN_H3K9me3_Mnase-ChIP_rep2.bigWig")
  bwlist1<-list("~/data/OSN/chip/H3K4me3/GSM7947099_OSN_WT_H3K4me3_Rep1.bw","~/data/OSN/chip/H3K4me3/GSM7947100_OSN_WT_H3K4me3_Rep2.bw")
...
for(i in c("Ago3","Wdr17")){
  file=str_c("~/F1_OSN/analysis/figure/Figure/",i,".pdf")
...
for(i in c("Ago3","Wdr17")){
  file=str_c("~/F1_OSN/analysis/figure/Figure/",i,"_chip.pdf")
