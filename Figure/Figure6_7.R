...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/Fish/experimental/Epha7_Fishresult.pdf",Epha7_p, device = "pdf", width = 6, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/Fish/experimental/Peg3_Fishresult.pdf",Peg3_p, device = "pdf", width = 6, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/Fish/experimental/Adcy3_Fishresult.pdf",Adcy3_p, device = "pdf", width = 6, height = 2, units = "cm", dpi = 60,bg="white")
...
pdf("/data/R02/huangtt39/F1_OSN/analysis/merge/OR_annalysis/multiome_scRNA_mature_ORNs_UMIs_cutoff_tunning.pdf",width=8)
i <- "_1"
...
save(filtered_mature_OSNs,file="/data/R02/huangtt39/F1_OSN/analysis/merge/OR_annalysis/filtered_mature_OSNs.RData")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/Epha7_OR_sample30.pdf",Epha7_OR_sample30, device = "pdf", width = 40, height = 10, units = "cm", dpi = 300)
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/Epha7_OR_meanexp.pdf",Epha7_OR_meanexp_p, device = "pdf", width = 10, height = 5, units = "cm", dpi = 300,bg="white")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/Epha7_OR_projection.pdf",plot_features(OR_group_up)+plot_layout(ncol=2,width=c(1,1.5)), device = "pdf", width = 25, height = 10, units = "cm", dpi = 300)
...
Epha7_AP_p<-ggviolin(OR_group_up_with_OB, x = "avg_exp_type", y = "scale_x", fill = "avg_exp_type", 
              ...
              theme(plot.title = element_text(hjust = 0.5), 
                ...
                legend.title = element_blank(),
                text=element_text(size=8))
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/Epha7_OR_projection_vln1.pdf",Epha7_DV_p+Epha7_AP_p, device = "pdf", width = 18, height = 10, units = "cm", dpi = 300)
...
Epha7_expVSMonocell_p<-ggplot(Epha7_dscore_in_ORgroup,aes(x =avg_exp , y =Mono_rate)) +
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        legend.position="right",text=element_text(size=6))
ggsave(filename =  "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/Epha7_expVScell.pdf",Epha7_expVSBicell_p+Epha7_expVSMonocell_p, device = "pdf", width =15, height = 8, units = "cm", dpi = 300,bg="white")
...
ORgroup_Epha7_Monocell<-ggviolin(Epha7_dscore_in_ORgroup, x = "avg_exp_type", y = "Mono_rate", fill = "avg_exp_type", 
              ...
              theme(plot.title = element_text(hjust = 0.5), 
                ...
                legend.title = element_blank(),
                text=element_text(size=8))
ggsave(filename = "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure4/ORgroup_Epha7_allele.pdf",ORgroup_Epha7_Bicell+ORgroup_Epha7_Monocell+ORgroup_Epha7_fc, device = "pdf", width = 24, height = 7, units = "cm", dpi = 300)
