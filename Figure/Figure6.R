...
# Figure 6a
for(i in c("Epha7")){
  file=str_c("~/F1_OSN/analysis/figure/Figure2/RME/high/",i,".pdf")
...
write.xlsx(final_gene_dscore%>%subset(gene=="Epha7"),file="~/F1_OSN/analysis/figure/Figure6/Figure6a.xlsx")
# result of Fish
# Figure 6b
...
ggsave(filename = "~/F1_OSN/analysis/Fish/experimental/Epha7_Fishresult.pdf",Epha7_p, device = "pdf", width = 4.5, height = 2, units = "cm", dpi = 60,bg="white")
write.xlsx(Epha7,file="~/F1_OSN/analysis/figure/Figure6/Figure6b.xlsx")
...
ggsave(filename = "~/F1_OSN/analysis/figure/Figure6/Epha7_OR_sample30.pdf",Epha7_OR_sample30, device = "pdf", width = 40, height = 10, units = "cm", dpi = 300)
expression_data <- FetchData(object = filtered_mature_OSNs, 
                             vars = c("Epha7", "expressed_OR"))
write.xlsx(expression_data, 
           file = "~/F1_OSN/analysis/figure/Figure6/Figure6c.xlsx",
...
ggsave(filename = "~/F1_OSN/analysis/figure/Figure6/Epha7_OR_meanexp.pdf",Epha7_OR_meanexp_p, device = "pdf", width = 10, height = 5, units = "cm", dpi = 300,bg="white")
...
OR_OB<-read.table(file="~/F1_OSN/CODE/data/OSN/projection/map_654.txt")%>%rename_with(~c("expressed_OR","cell","type","x","y"),1:5)
...
plot_features <- function(df, options = "viridis", directions = -1) {
  ...
  require(jpeg)
  require(ggpubr)
  img = readJPEG("~/F1_OSN/CODE/data/OSN/projection/projection3.jpg")
...
ggsave(filename = "~/F1_OSN/analysis/figure/Figure6/Epha7_OR_projection.pdf",plot_features(OR_group_up)+plot_layout(ncol=2,width=c(1,1.5)), device = "pdf", width = 25, height = 10, units = "cm", dpi = 300)
...
Epha7_AP_p<-ggviolin(OR_group_up_with_OB, x = "avg_exp_type", y = "scale_x", fill = "avg_exp_type", 
              ...
              theme(plot.title = element_text(hjust = 0.5), 
                ...
                legend.title = element_blank(),
                text=element_text(size=8))
ggsave(filename = "~/F1_OSN/analysis/figure/Figure6/Epha7_OR_projection_vln.pdf",Epha7_DV_p+Epha7_AP_p, device = "pdf", width = 18, height = 10, units = "cm", dpi = 300)
# 
...
Epha7_expVSMonocell_p<-ggplot(Epha7_dscore_in_ORgroup,aes(x =avg_exp , y =Mono_rate)) +
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        legend.position="right",text=element_text(size=6))
ggsave(filename =  "~/F1_OSN/analysis/figure/Figure6/Epha7_expVScell.pdf",Epha7_expVSBicell_p+Epha7_expVSMonocell_p, device = "pdf", width =15, height = 8, units = "cm", dpi = 300,bg="white")
...
ggsave(filename =  "~/F1_OSN/analysis/figure/Figure6/ORgroup_Epha7_fc.pdf",ORgroup_Epha7_fc, device = "pdf", width =15, height = 8, units = "cm", dpi = 300,bg="white")
...
ORgroup_Epha7_Monocell<-ggviolin(Epha7_dscore_in_ORgroup, x = "avg_exp_type", y = "Mono_rate", fill = "avg_exp_type", 
              ...
              theme(plot.title = element_text(hjust = 0.5), 
                ...
                legend.title = element_blank(),
                text=element_text(size=8))
ggsave(filename = "~/F1_OSN/analysis/figure/Figure6/ORgroup_Epha7_allele.pdf",ORgroup_Epha7_Bicell+ORgroup_Epha7_Monocell+ORgroup_Epha7_fc, device = "pdf", width = 24, height = 7, units = "cm", dpi = 300)
...
write.xlsx(Epha7_dscore_in_ORgroup%>%select(-scale_x,-scale_y,-fc,-fc1,-Bi_rate,-Mono_rate,-avg_exp_rank,x_rank,y_rank),file="~/F1_OSN/analysis/figure/Figure6/Figure6d-g.xlsx")
Epha7_dscore_in_ORgroup<-read.xlsx("~/F1_OSN/analysis/figure/Figure6/Figure6d-g.xlsx")