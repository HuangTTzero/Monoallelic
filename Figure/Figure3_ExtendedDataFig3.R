...
annotation<-import('~/F1_OSN/mapping/reference/mm10-2020-A-build/gencode.vM23.primary_assembly.annotation.gtf')
...
#   file = c("~/F1_OSN/mapping/joint202201/mapping_mask/joint202201_mask/outs/atac_fragments.tsv.gz","~/F1_OSN/mapping/jointF1OSN/mapping_mask/jointF1OSN_mask/outs/atac_fragments.tsv.gz","~/F1_OSN/mapping/jointF18w/mapping_mask/jointF18w_mask/outs/atac_fragments.tsv.gz")
# )

dirs<-c("~/F1_OSN/mapping/joint202201/mapping_allele/joint202201_G1count/outs/","~/F1_OSN/mapping/joint202201/mapping_allele/joint202201_G2count/outs/","~/F1_OSN/mapping/jointF1OSN/mapping_allele/jointF1OSN_G1count/outs/","~/F1_OSN/mapping/jointF1OSN/mapping_allele/jointF1OSN_G2count/outs/","~/F1_OSN/mapping/jointF18w/mapping_allele/jointF18w_G1count/outs/","~/F1_OSN/mapping/jointF18w/mapping_allele/jointF18w_G2count/outs/") 
...
save(Obj,file="~/F1_OSN/new_analysis/Obj.RData")
...
write.xlsx(high_RME,file="~/F1_OSN/new_analysis/high_RME.xlsx")

# Figure 3a and 3b
for(i in c("Ago3","Stk40")){
  file=str_c("~/F1_OSN/analysis/figure/Figure3/RME/high/",i,".pdf")
...
write.xlsx(final_gene_dscore%>%subset(gene%in%c("Ago3","Stk40"))%>%select(-c(Oripeak, Orirna, rnascore,atacscore,allele_exp,allele_frag,rna_dscore_type)),file="~/F1_OSN/analysis/figure/Figure3/Figure3ab.xlsx")
...
for(i in top_OR){
  file=str_c("~/F1_OSN/analysis/figure/Figure2/RME/OR/",i,".pdf")
  ggsave(filename = file,heat_track(i)+reads_bar_gene(i)+plot_layout(nrow=6,ncol=2,heights = c(1,1.2,1.2,1.2,0.6,3),widths=c(4,1)), device = "pdf", width = 20, height =20, units = "cm", dpi = 300,bg="white")
}
...
for(i in c("Ophn1","Diaph2")){
  file=str_c("~/F1_OSN/analysis/figure/Figure2/RME/chrX/",i,".pdf")
  ggsave(filename = file,heat_track(i)+reads_bar_gene(i)+plot_layout(nrow=6,ncol=2,heights = c(1,1.2,1.2,1.2,0.6,3),widths=c(4,1)), device = "pdf", width = 20, height =20, units = "cm", dpi = 300,bg="white")
}
write.xlsx(final_gene_dscore%>%subset(gene%in%c("Olfr1178","Olfr309","Ophn1","Diaph2"))%>%select(-c(Oripeak, Orirna, rnascore,atacscore,allele_exp,allele_frag,rna_dscore_type)),file="~/F1_OSN/analysis/figure/FigureS3/FigureS3a-d.xlsx")


# 与NPC gene之间的交集
NPC_RME<-read.xlsx("~/F1_OSN/CODE/data/mouse/ESC_NPC_RME.xlsx",sheet = 2,startRow=4)
RME_sameNPC<-RME%>%subset(gene%in%NPC_RME$Gene.Name) #1 genes

# 与Adut DAR DAEE gene之间的交集
DRN_RME<-read.xlsx("~/F1_OSN/CODE/data/mouse/DAEE_in_Mouse.xlsx",sheet = 1)
...
ARN_RME<-read.xlsx("~/F1_OSN/CODE/data/mouse/DAEE_in_Mouse.xlsx",sheet = 4)
...
ggsave(filename = "~/F1_OSN/analysis/Fish/experimental/Peg3_Fishresult.pdf",Peg3_p, device = "pdf", width = 4.5, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "~/F1_OSN/analysis/Fish/experimental/Adcy3_Fishresult.pdf",Adcy3_p, device = "pdf", width = 4.5, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "~/F1_OSN/analysis/Fish/experimental/Ago3_Fishresult.pdf",Ago3_p, device = "pdf", width = 4.5, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "~/F1_OSN/analysis/Fish/experimental/Kcnh7_Fishresult.pdf",Kcnh7_p, device = "pdf", width = 4.5, height = 2, units = "cm", dpi = 60,bg="white")
...
ggsave(filename = "~/F1_OSN/analysis/figure/Figure2/high_RME_rank.pdf",high_RME_count_p+high_RME_ratio_p+plot_layout(heights=c(1,1.5)), device = "pdf", width = 24, height = 14, units = "cm", dpi = 300,bg="white")
...
write.xlsx(no_biallelic_ratio%>%subset(type%in%c("chrX","OR")),file="~/F1_OSN/analysis/figure/FigureS3/FigureS3e-f.xlsx")
...
ggsave(filename = "~/F1_OSN/analysis/figure/Figure2/OR_rank.pdf",OR_count_p+OR_ratio_p+plot_layout(heights=c(0.5,1.5)), device = "pdf", width = 16, height = 10, units = "cm", dpi = 300,bg="white")
ggsave(filename = "~/F1_OSN/analysis/figure/Figure2/chrX_rank.pdf",chrX_count_p+chrX_ratio_p+plot_layout(heights=c(0.5,1.5)), device = "pdf", width = 21, height = 10, units = "cm", dpi = 300,bg="white")
...
write.xlsx(RME_GOenrichment_result,file="~/F1_OSN/new_analysis/RME_GOenrichment_result.xlsx")
