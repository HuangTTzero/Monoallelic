...
## Load the data
dirs <- c("/data/R02/huangtt39/F1_OSN/mapping/joint202201/mapping_mask/joint202201_mask/outs/","/data/R02/huangtt39/F1_OSN/mapping/jointF1OSN/mapping_mask/jointF1OSN_mask/outs/","/data/R02/huangtt39/F1_OSN/mapping/jointF18w/mapping_mask/jointF18w_mask/outs/")
...
# qc plot, Extended Data Fig. 1a-b
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/qc_all.pdf", vln_all, device = "pdf", width = 30, height = 30, units = "cm", dpi = 300,bg="white")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/qc_all1.pdf", vln_all1, device = "pdf", width = 30, height = 10, units = "cm", dpi = 300,bg="white")
write.xlsx(combined@meta.data, "/data/R02/huangtt39/F1_OSN/analysis/figure/FigureS1/FigureS1a-b.xlsx")
...
dataset1_fragfile <- "/data/R02/huangtt39/F1_OSN/mapping/joint202201/mapping_mask/joint202201_mask/outs/atac_fragments.tsv.gz"
dataset2_fragfile <- "/data/R02/huangtt39/F1_OSN/mapping/jointF1OSN/mapping_mask/jointF1OSN_mask/outs/atac_fragments.tsv.gz"
dataset3_fragfile <- "/data/R02/huangtt39/F1_OSN/mapping/jointF18w/mapping_mask/jointF18w_mask/outs/atac_fragments.tsv.gz"
...
write.table(dataset1_res,"/data/R02/huangtt39/F1_OSN/F1joint_mask/dataset1_scDblFinder_result.txt",row.names=TRUE,col.names=TRUE,sep="\t",quote=FALSE)
...
write.table(dataset2_res,"/data/R02/huangtt39/F1_OSN/F1joint_mask/dataset2_scDblFinder_result.txt",row.names=TRUE,col.names=TRUE,sep="\t",quote=FALSE)
...
write.table(dataset3_res,"/data/R02/huangtt39/F1_OSN/F1joint_mask/dataset3_scDblFinder_result.txt",row.names=TRUE,col.names=TRUE,sep="\t",quote=FALSE)
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/data1_doublet.pdf",data1_rna_umap +data1_atac_umap + data1_wnn_umap & theme(plot.title = element_text(hjust = 0.5,size=8),text=element_text(size=8),axis.text.y=element_text(size=8,color = "black"), axis.text.x=element_text(size=8,  color = "black")), device = "pdf", width = 24, height = 8, units = "cm", dpi = 300)
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/data3_doublet.pdf",data3_rna_umap +data3_atac_umap + data3_wnn_umap & theme(plot.title = element_text(hjust = 0.5,size=8),text=element_text(size=8),axis.text.y=element_text(size=8,color = "black"), axis.text.x=element_text(size=8,  color = "black")), device = "pdf", width = 24, height = 8, units = "cm", dpi = 300)
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/umap_after.pdf",rna_umap + atac_umap + wnn_umap & NoLegend() & theme(plot.title = element_text(hjust = 0.5,size=8),text=element_text(size=8),axis.text.y=element_text(size=8,color = "black"), axis.text.x=element_text(size=8,  color = "black")), device = "pdf", width = 30, height = 10, units = "cm", dpi = 300)
batch_umap <- DimPlot(combined, reduction = "wnn.umap",group.by = 'orig.ident',  pt.size = 0.3) + ggtitle("WNN")
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/batch.pdf",batch_umap & theme(plot.title = element_text(hjust = 0.5,size=8),text=element_text(size=8),axis.text.y=element_text(size=8,color = "black"), axis.text.x=element_text(size=8,  color = "black")), device = "pdf", width = 10, height = 10, units = "cm", dpi = 300)
...
save(combined,file="~/F1_OSN/F1joint_mask/combined.RData")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/umap_after_celltype.pdf",p, device = "pdf", width =40, height = 10, units = "cm", dpi = 300)
umap_coords <- as.data.frame(Embeddings(combined, "wnn.umap"))
umap_coords$barcode<-rownames(umap_coords)
umap_coords<-merge(umap_coords, combined@meta.data%>%select(barcode,celltype),by="barcode")
write.xlsx(umap_coords, "/data/R02/huangtt39/F1_OSN/analysis/figure/Figure2/Figure2a.xlsx")
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/celltype.pdf",cell_number_p, device = "pdf", width =15, height = 10, units = "cm", dpi = 300)


# maker expression plot, Extended Data Fig. 1a-b
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/dotplot.pdf",dotplot+theme(plot.title = element_text(hjust = 0.5,size=8),text=element_text(size=8),axis.text.y=element_text(size=8,color = "black"), axis.text.x=element_text(size=8,  color = "black")), device = "pdf", width = 18, height = 8, units = "cm", dpi = 300)
write.xlsx(dotplot$data, "/data/R02/huangtt39/F1_OSN/analysis/figure/FigureS1/FigureS1c.xlsx")
...
save(Combined_mOSN,file="~/F1_OSN/F1joint_mask/Combined_mOSN.RData")
