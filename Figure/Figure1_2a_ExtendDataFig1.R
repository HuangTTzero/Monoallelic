...
# qc plot, Extended Data Fig. 1a-c
...
ggsave(filename = "/data/R02/huangtt39/F1_OSN/F1joint_mask/celltype_pct.pdf",cell_number_p, device = "pdf", width =15, height = 10, units = "cm", dpi = 300)
